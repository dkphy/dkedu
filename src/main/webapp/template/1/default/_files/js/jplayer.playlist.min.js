        ...
        jPlayerPlaylist = function(b, c, d) {
            ...
            jPlayerPlaylist.prototype = {
                ...
                _createListItem: function(b) {
                    ...
                    // return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'>" + b.title + (b.artist ? " <span class='jp-artist'>by " + b.detail + "</span>": "") + "</a>",
                    //     d += "</div></li>"

                    /*by slimcheng */
                    return d += "<b class='jp-title'>" + b.title +"</b>"+ " <span class='jp-artist'>" +(b.artist ?  b.artist: "") + "</span>"+ "<p class='jp-detail'>"+(b.detail ? b.detail:"")+"</p>",
                        d += "</div></li>"
