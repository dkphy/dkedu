...
<div class="c-bar margin-top5">
  <span class="c-position">成绩管理 - 成绩列表</span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab">姓名: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}"/></label>
	  <label class="c-lab">身份证号: <input type="text" name="search_CONTAIN_post" value="${search_CONTAIN_post[0]}"/></label>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls-th-sort"><span class="ls-sort" pagesort="name">姓名</span></th>
    <th class="ls-th-sort"><span class="ls-sort" pagesort="idCard">身份证号</span></th>
    <th class="ls-th-sort"><span class="ls-sort" pagesort="score">成绩</span></th>
    <th class="ls-th-sort"><span class="ls-sort" pagesort="gmtCreate">操作日期</span></th>
  </tr>
  </thead>
  <tbody>
  ...
  <tr<shiro:hasPermission name="plug:resume:edit"> ondblclick="location.href=$('#edit_opt_${bean.id}').attr('href');"</shiro:hasPermission>/>
    ...
    <td><c:out value="${bean.idCard}"/></td>
   <td><c:out value="${bean.score}"/></td>
    <td align="center"><fmt:formatDate value="${bean.gmtCreate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
  </tr>
  </c:forEach>
  </tbody>
</table>
