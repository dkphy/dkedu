...
<div class="c-bar margin-top5">
  <span class="c-position">成绩管理 - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    <td class="in-lab" width="15%"><em class="required">*</em>姓名:</td>
    <td class="in-ctt" width="35%"><f:text name="name" value="${oprt=='edit' ? (bean.name) : ''}" class="required" maxlength="100" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in-lab" width="15%"><em class="required">*</em>身份证号:</td>
    <td class="in-ctt" width="35%"><f:text name="idCard" value="${bean.idCard}" class="required" maxlength="100" style="width:180px;"/></td>
  </tr>
  <tr>
    <td class="in-lab" width="15%">成绩:</td>
    <td class="in-ctt" width="35%"><f:text name="score" value="${bean.score}" maxlength="100" style="width:180px;"/></td>
  </tr>
  <tr>
    <td colspan="2" class="in-opt">
