...
.desc{float:left;height:180px;width:430px;padding-top:40px;text-align:center;color:#0e6d0e;font-size:28px;font-weight:bold;background:url('${ctx}/static/back/images/admin_logo.png') no-repeat center 0px;}
