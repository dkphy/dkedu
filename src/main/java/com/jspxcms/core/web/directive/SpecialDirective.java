 ...
 * 
 */
public class SpecialDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Special special = query.get(id);
		loopVars[0] = env.getObjectWrapper().wrap(special);
		body.render(env.getOut());
	}

	@Autowired
	private SpecialService query;
}
