...
public class FavoritesController {
	...
	@ResponseBody
	@RequestMapping(value = "/addConnection.jspx")
	public boolean addConnection(Integer page,Integer userId,Integer objectId,String type,Model modMap,HttpServletRequest request){
